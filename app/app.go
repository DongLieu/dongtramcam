...
const (
	AccountAddressPrefix = "dongtramcam"
	Name                 = "dongtramcam"
)
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		dongtramcammodule.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	DongtramcamKeeper dongtramcammodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		dongtramcammoduletypes.StoreKey,
	...
	*/
	...
	app.DongtramcamKeeper = *dongtramcammodulekeeper.NewKeeper(
		appCodec,
		keys[dongtramcammoduletypes.StoreKey],
		keys[dongtramcammoduletypes.MemStoreKey],
		app.GetSubspace(dongtramcammoduletypes.ModuleName),
	)
	dongtramcamModule := dongtramcammodule.NewAppModule(appCodec, app.DongtramcamKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		dongtramcammoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(dongtramcammoduletypes.ModuleName)
